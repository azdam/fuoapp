...
class AccomodationsControllerTest < ActionController::TestCase
  ...
  test "should create accomodation" do
    assert_difference('Accomodation.count') do
      post :create, accomodation: { hostel: @accomodation.hostel, room_nos: @accomodation.room_nos, status: @accomodation.status, user_id: @accomodation.user_id, validity_period: @accomodation.validity_period }
    end
  ...
  test "should update accomodation" do
    patch :update, id: @accomodation, accomodation: { hostel: @accomodation.hostel, room_nos: @accomodation.room_nos, status: @accomodation.status, user_id: @accomodation.user_id, validity_period: @accomodation.validity_period }
    assert_redirected_to accomodation_path(assigns(:accomodation))
  end
