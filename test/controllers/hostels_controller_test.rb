...
class HostelsControllerTest < ActionController::TestCase
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post :create, hostel: { description: @hostel.description, name: @hostel.name, room_count: @hostel.room_count }
    end
  ...
  test "should update hostel" do
    patch :update, id: @hostel, hostel: { description: @hostel.description, name: @hostel.name, room_count: @hostel.room_count }
    assert_redirected_to hostel_path(assigns(:hostel))
  end
